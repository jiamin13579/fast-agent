...
public interface ScheduledTaskMapper {
    ...
    @Insert("INSERT INTO agent_scheduled_task (name, cron, prompt, webhook_url, enabled, durable, skill_id, params, last_run, created_at, updated_at) " +
    ...
    @Update("UPDATE agent_scheduled_task SET name=#{name}, cron=#{cron}, prompt=#{prompt}, webhook_url=#{webhookUrl}, " +
