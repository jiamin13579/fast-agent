...
import com.fast.agent.mcp.McpGateway;
import com.fast.agent.mcp.McpResponse;
...
public class McpTool {
    ...
    @Autowired private McpGateway mcpGateway;
    ...
    public String refreshData(@Param(name = "source", description = "数据源名称") String source) {
