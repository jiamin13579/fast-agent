...
### 1. Start Environment
```bash
bash skills/fast-agent-test-env-monitoring/scripts/test-env.sh
```
...
```bash
cp skills/fast-agent-test-env-monitoring/templates/bug-report.md \
...
| Path | Purpose |
|------|---------|
| `skills/fast-agent-test-env-monitoring/` | Skill source (canonical) |
| `.claude/skills/fast-agent-test-env-monitoring/` | Skill deployment (auto-discovered) |
